...
if __name__ == '__main__':
    ...
    from_cam=rospy.get_param('/set_cams_transforms/cam1')
    to_cam=rospy.get_param('/set_cams_transforms/cam2')
    #try:
    ...
    x=rospy.get_param('/set_cams_transforms/x')
    y=rospy.get_param('/set_cams_transforms/y')
    z=rospy.get_param('/set_cams_transforms/z')
    yaw=rospy.get_param('/set_cams_transforms/yaw')
    pitch=rospy.get_param('/set_cams_transforms/pitch')
    roll=rospy.get_param('/set_cams_transforms/roll')
    status = {'mode': 'pitch',
              'x': {'value': x, 'step': 0.1},
              'y': {'value': y, 'step': 0.1},
              'z': {'value': z, 'step': 0.1},
